...
public class BoatPhysics : MonoBehaviour 
{
    ...
    [SerializeField] private float rhoAir = 1.225f;   // 공기 밀도(kg/m^3)
    [SerializeField] private float airResistanceC_r = 0.8f; // 공기 저항 계수
    [SerializeField] private float boatMass = 1200f;
    ...
    void AddAboveWaterForces()
    {
        ...
        for (int i = 0; i < aboveWaterTriangleData.Count; i++)
        {
            ...
            forceToAdd += BoatPhysicsMath.AirResistanceForce(rhoAir, triangleData, airResistanceC_r);
